# This Makefile is for the Minion::Command::minion::jobx extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Minion/Command/minion/jobx.pm]
...
MAKE = make
FULLEXT = Minion/Command/minion/jobx
BASEEXT = jobx
PARENT_NAME = Minion::Command::minion
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Minion/Command/minion/jobx.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Minion/Command/minion
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Minion/Command/minion
...
TO_INST_PM = lib/Minion/Command/minion/jobx.pm

PM_TO_BLIB = lib/Minion/Command/minion/jobx.pm \
...
manifypods : pure_all  \
	lib/Minion/Command/minion/jobx.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Minion/Command/minion/jobx.pm $(INST_MAN3DIR)/Minion::Command::minion::jobx.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  $(BASEEXT).exp 
	- $(RM_RF) \
	  Minion-Command-minion-jobx-* blib 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The clone of Minion::Command::minion::job but with some output changes.</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Minion/Command/minion/jobx.pm blib/lib/Minion/Command/minion/jobx.pm 
